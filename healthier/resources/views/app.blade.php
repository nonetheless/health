            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="/user/home/{{$_SESSION['id']}}">个人主页</a></li>
                        <li><a href="/game/all">活动主页</a></li>
                        <li><a href="/health/user">健康主页</a></li>
                        <li><a href="/health/import">导入数据</a></li>

                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="user" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <img src="/image/user{{$_SESSION['id']}}.jpg" alt="nonetheless" class = "user_header img-circle" border="0" style="height: 25px;width: 25px">
                                <ul class="dropdown-menu">
                                    <li><a href="/setting/{{$_SESSION['id']}}">个人设置</a></li>
